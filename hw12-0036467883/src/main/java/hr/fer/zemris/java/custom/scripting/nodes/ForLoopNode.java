...
/**
 * Predstavlja čvor koji sadrži vrijednosti for petlje. Sadrži 4 člana od kojih
 * prvi predstavlja varijablu po kojoj se vrti petlja, drugi predstavlja početni
 * broj, a treći zadnji broj iteracije. Zadnji član može biti null ili broj. Ako
 * je broj onda predstavlja za koliko se mijenja varijabla svake iteracije.
 * 
 * @author Ivan Jukić
 *
 */
...
public class ForLoopNode extends Node {
	...
	/**
	 * Vraća String reprezentaciju for petlje. Na početak stavlja {$ zatim zapisuje
	 * članove for petlje i zatvara petlju s $}. Nakon toga pretražuje tijelo for
	 * petlje, tj. djecu čvora te ih dodaje u String. Na kraju se dodaje {$END$} tag
