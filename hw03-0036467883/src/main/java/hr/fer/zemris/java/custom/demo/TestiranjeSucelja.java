...
/**
 * Main aplikacija koja testira sučelja za ArrayIndexedCollection i LinkedListCollection.
 * 
 * @author Ivan Jukić
 *
 */

public class TestiranjeSucelja {
	...
	public static void main(String[] args) {
		...
		col1.get(0);
		col2.get(0);
		((ArrayIndexedCollection) col3).get(0); // neće se prevesti! Razumijete li zašto? NE!
