...
public class ArrayIndexedCollection implements List {
	...
	private static class ArrayListElementsGetter implements ElementsGetter {
		...
		private ArrayListElementsGetter(ArrayIndexedCollection list) {
		...
		public Object getNextElement() {
			...
			if(this.savedModificationCount != list.modificationCount) {
				...
				Object elementToReturn = list.elements[iteratorPointer];
				iteratorPointer++;
				return elementToReturn;
			} else {
				throw new NoSuchElementException("Element na postoji.");
			}
